...
import { Car, Code2, User2, Music, Package, Brush } from "lucide-react"
...
const categories = [
  {
    ...
    icon: Car,
    description: "Classic vehicle models for GTA IV",
    count: 1234,
  ...
  },
  {
    title: "Plugins",
    icon: Code2,
    description: "Game-enhancing plugins and modifications",
    count: 567,
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1543465077-db45d34b88a5?w=1600&h=900&fit=crop"
            alt="GTA IV Hero"
        ...
        <div className="relative container mx-auto h-full flex items-center">
          <div className="max-w-2xl text-white">
            <h1 className="text-5xl font-bold mb-4">Grand Theft Auto IV</h1>
            <p className="text-xl text-white/90 mb-6">
              Step into Liberty City with our extensive collection of police modifications for GTA IV.
              Experience enhanced law enforcement gameplay with our carefully curated mods.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((category) => {
            ...
            return (
              <Link 
                key={category.title} 
                href={`/game/iv/${category.title.toLowerCase().replace(/\s+/g, "-")}`}
              >
